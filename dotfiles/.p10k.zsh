# Generated by Powerlevel10k configuration wizard on 2024-08-21 at 17:23 EDT.
...
# Shirom
#
# Changed prompt char to cyan
# Changed vcs branch and icon to cyan
# Changed directory to purple
#
# Note that this is only using 8 colors, makes things easier
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local  untracked='%6F'  # blue foreground Shirom
      local conflicted='%1F'  # red foreground
      local branchcol='%4F' # Shirom
    else
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${branchcol}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi
